...
# #############################################################################
# NOTE if DEMO_MODE is True, then reduced functionalities will be available
# ############################################################################# 
DEMO_MODE_FLAG = True



SECRET_KEY = 'q*lq9&h%*@($^@)_&@@$!&*(asd67ta8dsjgajsdg'
...
if ENVIRONMENT == 'local':
    STATIC_ROOT = os.path.join(SITE_ROOT, 'collectstatic/hacks2019')
else:
    #  modify as needed
